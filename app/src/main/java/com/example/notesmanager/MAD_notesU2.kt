    ...
    LazyColumn(
        ...
        item {
            Column(
                ...
                Text("   -> Limit the features available on each screen, and use small," +
                ...
                Text(" -> Help users fight cognitive distractions with a clear" +
                ...
                Text(" -> Focused content means users won’t leave because it takes" +
